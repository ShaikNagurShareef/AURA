"""
AURA – Dynamic Gemini Model Selector
...
def select_models() -> Tuple[str, str]:
    ...
    try:
        ...
        pro = _pick(PRO_CANDIDATES, available, fallback="gemini-3.1-pro")
        flash = _pick(FLASH_CANDIDATES, available, fallback="gemini-3-flash")
