...
<head>
    <meta charset="UTF-8">
    <title>AURA Clinical Report — ${agentName}</title>
    <style>
...
<body>
    ...
    <div class="disclaimer-box">
        <strong>Important Notice:</strong> This report contains AI-generated clinical guidance from AURA.
    ...
    <div class="report-footer">
        <span>AURA Clinical Intelligence Platform — Georgia State University</span>
