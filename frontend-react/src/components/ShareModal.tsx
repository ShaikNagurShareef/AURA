...
const ShareModal: React.FC<ShareModalProps> = ({ agentName, agentRole, chatText, onClose }) => {
    ...
    const [subject, setSubject] = useState(`AURA ${agentName} Consultation — ${new Date().toLocaleDateString()}`);
    ...
    const sendWhatsApp = async () => {
        ...
        const text = `*AURA ${agentName} Consultation*\n` +
                        ...
                        {emailStatus === 'sent' ? (
                            ...
                            <>
                                ...
                                <p className="share-hint">
                                    Emails are sent from the AURA platform Gmail account configured by your administrator.
                                </p>
                            </>
                        )}
                    </div>
                    ...
                    <div className="share-content">
                        {waStatus === 'sent' ? (
                            ...
                            <>
                                ...
                                <p className="share-hint">
                                    Delivers message directly via AURA infrastructure without opening your WhatsApp application.
                                </p>
                            </>
                        )}
                    </div>
