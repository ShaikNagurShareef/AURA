...
const teamMembers = [
    { name: 'Nagur Shareef Shaik', firstName: 'Nagur', initials: 'NS', email: 'nshaik3@student.gsu.edu' },
    { name: 'Aasrith Mandava', firstName: 'Aasrith', initials: 'AM', email: 'amandava2@student.gsu.edu' },
    { name: 'Sri Venkata Naga Sai Kakani', firstName: 'Sri', initials: 'SK', email: 'skakani1@student.gsu.edu' },
    { name: 'Asish Karthikeya Gogineni', firstName: 'Asish', initials: 'AG', email: 'agogineni2@student.gsu.edu' },
];
...
const modelInfo = [
    {
        ...
        release: 'Latest',
        context: '1M tokens',
        use: 'APOLLO (Virtual Doctor), AURA Orchestrator — complex multi-step medical reasoning and A2A coordination.',
        badge: 'REASONING',
        color: '#0F52BA',
    },
    {
    ...
    return (
        <div className="about-container animate-fade-in">
            ...
            <header className="about-hero">
                ...
                <h1>About <span className="gradient-text">AURA</span></h1>
            ...
            <section className="about-section bg-secondary">
                <div className="about-section-header">
                    ...
                    <p>AURA runs on Google's latest Gemini 3 family. Our models are heavily benchmarked against leading open-source medical diagnostics datasets.</p>
                </div>
