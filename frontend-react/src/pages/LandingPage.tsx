            ...
            <nav className="landing-nav">
                <div className="nav-container">
                    <div className="landing-logo">
                        <img src="/assets/logo.png" alt="AURA Logo" style={{ height: '32px', marginRight: '8px', verticalAlign: 'middle' }} />
                        AURA <span className="logo-light">Enterprise</span>
                    </div>
            ...
            <div className="landing-container animate-fade-in">
                ...
                <header className="landing-hero">
                    ...
                    <p className="landing-hero-sub">
                        ...
                        AURA leverages advanced Vision Transformers (ViT) and multi-task setups so clinical priors no longer overshadow noisy visual signals.
                    </p>
                ...
                <footer className="landing-footer">
                    <div className="footer-brand">
                        <div className="footer-logo">
                            <img src="/assets/logo.png" alt="AURA Logo" style={{ height: '24px', marginRight: '8px', verticalAlign: 'middle' }} />
                            AURA Enterprise
                        </div>
                        <p>© 2026 AURA Healthcare Systems. HIPAA-Aware Design.</p>
                    </div>
