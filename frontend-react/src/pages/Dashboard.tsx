        ...
        <div className="dashboard-container animate-fade-in">
            ...
            <section className="dashboard-hero">
                <div className="hero-text">
                    ...
                    <p>
                        AURA is ready. Select an agent below or use the Master Chat to let AI route your query automatically.
                    </p>
                </div>
            ...
            <section className="about-strip">
                <div className="about-strip-text">
                    <h2><Info size={20} /> Why AURA?</h2>
                    <p>
                        AURA bridges the gap between advanced AI reasoning and everyday clinical workflows.
