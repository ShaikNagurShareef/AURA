    ...
    return (
        <div className="settings-container animate-fade-in">
            <header className="settings-header">
                ...
                <p>Manage your AURA Enterprise account settings and security.</p>
            </header>
                    ...
                    {activeTab === 'notifications' && (
                        <div className="settings-form animate-fade-in">
                            <div className="form-section">
                                ...
                                <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginBottom: '1.5rem' }}>Control what alerts and digests you receive from AURA.</p>
                    ...
                    {activeTab === 'sessions' && (
                        <div className="settings-form animate-fade-in">
                            <div className="form-section">
                                ...
                                <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginBottom: '1.5rem' }}>Review devices currently logged into your AURA Enterprise account.</p>
