...
const agentInfo: Record<string, {
    ...
    'orchestrator': { name: 'AURA', role: 'Master Orchestrator', color: '#0F52BA', Icon: Brain, systemPrompt: "Hello! I'm AURA Orchestrator. Ask me anything health-related and I'll route it to the right specialist." },
};
        ...
        const handleVoiceShareEmail = async (e: any) => {
            ...
            try {
                await api_client.sendEmail({
                    to: email,
                    subject: `AURA Consultation: ${agent.name}`,
                    body: transcript
                });
